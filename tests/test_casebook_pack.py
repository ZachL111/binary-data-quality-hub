"""Regression checks for the binary-data-quality-hub casebook."""
...
from casebook.harness import assert_expected, binary_data_quality_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(binary_data_quality_hub_summary(), assert_expected())
